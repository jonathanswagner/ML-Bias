...
def calc_disparity_index(data, target_variable, protected_variable):
    df_aif = BinaryLabelDataset(df=data, label_names=[target_variable],
                                protected_attribute_names=[protected_variable])
    privileged_group = [{protected_variable: 1}] #male=1
    unprivileged_group = [{protected_variable: 0}] #female=0
